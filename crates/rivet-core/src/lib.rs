...
pub use extract::{
    ...
    ExtractedSymbol, ExtractedUse, ImportKind, LocalBinding, ModuleImport, ModuleImportKind,
    NewBinding, ScopeFacts, ScopeImport, SupertypeRelation, TypedBinding, UseHint,
};
