...
| Not resolved in v0.1 | Container bindings, magic methods, trait composition, inheritance traversal, `static::`, variable function/member names, docblock inferred types | Path aliases, package resolution, re-exports, CommonJS, inheritance, structural typing, unions/generics, decorators' runtime effects, computed dynamic names |
